...
def make_briefing(items: list[dict], prev: dict | None) -> dict | None:
    ...
    prompt = (
        ...
        '{"headline": "...", "bullets": ["...", "..."]}\n'
        "headline 규칙: 목록에서 가장 중요한 이슈(들)를 골라 구체적인 기업명·사건·수치가 "
        "들어간 뉴스 헤드라인체 한 문장(60자 이내). 예시 톤: '메타 클라우드 진출 충격에 반도체 "
        "급락, 삼성 DRAM 20% 인상 추진'. '오늘의 소식', 'AI·투자 동향' 같은 포괄적·모호한 "
        "제목은 금지.\n"
        "bullets 규칙: 나머지 주요 주제별 요점 3~5개, 각 45자 이내, 구체적 사실 위주.\n\n" + lines
    )
